  ...
  return (
    <div className="max-w-4xl mx-auto py-8 px-4 text-left">
      ...
      <div className="text-center md:text-left space-y-2 mb-8">
        <span className="inline-block bg-[var(--pc-red-500)]/10 text-[var(--pc-red-500)] text-[10px] font-black uppercase tracking-widest px-3 py-1 rounded-full">
          Realtime Pizza City Transit Tracker
        </span>
        <h2 className="font-playfair font-black text-3xl md:text-4xl text-[var(--pc-gray-700)]">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
        ...
        <div className="lg:col-span-5 space-y-6">
          <div className="bg-white rounded-3xl border border-gray-200 p-6 shadow-xs flex flex-col gap-4">
            <h3 className="font-playfair font-black text-lg text-[var(--pc-gray-700)] flex items-center gap-2">
              <Search size={18} className="text-[var(--pc-red-500)]" />
              Track Order Status
            </h3>
            ...
            <div className="space-y-3">
              <div className="relative">
                <input
                  ...
                  className="w-full bg-[var(--pc-gray-100)] border border-[var(--pc-red-500)]/20 rounded-2xl pl-4 pr-12 py-3.5 text-xs text-[var(--pc-gray-600)] font-bold focus:outline-none focus:border-[var(--pc-amber-400)] focus:ring-1 focus:ring-[var(--pc-amber-400)] placeholder-gray-400"
                ...
                <button
                  ...
                  disabled={isLoading}
                  className="absolute right-2 top-2 bottom-2 bg-gradient-to-r from-[var(--pc-red-500)] to-[var(--pc-amber-400)] text-white px-3.5 rounded-xl flex items-center justify-center transition-all cursor-pointer hover:scale-[1.02] active:scale-98 disabled:opacity-50"
              ...
              <p className="text-[10px] text-[var(--pc-gray-500)] font-medium leading-relaxed pl-1">
          ...
          <div className="bg-white rounded-3xl border border-gray-200 p-6 shadow-xs flex flex-col gap-4">
            <div className="flex items-center justify-between">
              <h3 className="font-playfair font-black text-sm text-[var(--pc-gray-700)] flex items-center gap-1.5">
                <Bell size={16} className="text-[var(--pc-amber-400)]" />
                Live Status Watcher
              </h3>
            ...
            <div className="space-y-3.5 text-xs">
              <p className="text-[11px] text-[var(--pc-gray-500)] leading-relaxed">
              ...
              <div className="flex flex-wrap gap-2 pt-1">
                ...
                {notificationPermission === "granted" ? (
                  <div className="flex items-center gap-1.5 bg-emerald-50 text-emerald-800 border border-emerald-200 text-[10px] font-black px-3 py-1.5 rounded-xl">
                ...
                <button
                  type="button"
                  onClick={playChime}
                  className="flex items-center gap-1.5 bg-slate-50 hover:bg-slate-100 text-slate-700 border border-slate-200/50 text-[10px] font-black px-3 py-1.5 rounded-xl transition-all cursor-pointer"
              ...
              {order && order.status !== "delivered" && order.status !== "cancelled" ? (
                ...
                <div className="pt-2 border-t border-gray-100 text-[9px] text-[var(--pc-gray-500)] italic">
          ...
          {recentOrders.length > 0 && (
            <div className="bg-white rounded-3xl border border-gray-200 p-6 shadow-xs space-y-3">
              <div className="flex items-center justify-between">
                <h4 className="text-[10px] uppercase font-black tracking-wider text-[var(--pc-gray-500)] flex items-center gap-1.5 matches-label">
                  <History size={12} />
        ...
        <div className="lg:col-span-7">
          {isLoading ? (
            <div className="bg-white rounded-[2rem] border border-gray-200 p-12 text-center flex flex-col items-center justify-center space-y-4 shadow-xs min-h-[350px]">
              <div className="w-12 h-12 rounded-full border-4 border-t-[var(--pc-red-500)] border-orange-50 animate-spin flex items-center justify-center" />
              <div className="space-y-1">
                <p className="font-playfair font-black text-lg text-[var(--pc-gray-700)]">Connecting to kitchen network...</p>
                <p className="text-xs text-[var(--pc-gray-500)]">Retrieving latest oven coordinates and logistics status...</p>
              </div>
            </div>
          ) : error ? (
              ...
              <div className="p-6 md:p-8 space-y-8">
                {isCancelled ? (
                  ...
                  <div className="relative">
                    ...
                    <motion.div
                      className="absolute top-[22px] left-[20px] h-[3px] bg-[var(--pc-red-500)] -z-0"
                      initial={{ width: "0%" }}
                        ...
                        return (
                          <div key={idx} className="flex flex-col items-center text-center group">
                            ...
                            <div className={`w-11 h-11 rounded-full flex items-center justify-center transition-all ${
                              isDone 
                                ? "bg-[var(--pc-red-500)] text-white shadow-[var(--pc-red-500)]/20 shadow-md ring-4 ring-[var(--pc-gray-100)]" 
                            ...
                            <div className="mt-3.5 space-y-0.5 px-1">
                              <p className={`text-[11px] font-black leading-tight ${
                                isActive ? "text-[var(--pc-red-500)]" : isDone ? "text-[var(--pc-gray-700)]" : "text-gray-400"
                              }`}>
                                {step.title}
                              </p>
                              <p className="hidden sm:block text-[9px] text-[var(--pc-gray-500)] font-medium leading-tight">
                                {step.desc}
                              </p>
                            </div>
                          </div>
                ...
                <div className="bg-neutral-50/70 border border-neutral-100 rounded-3xl p-5 space-y-4">
                  <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2 pb-3 border-b border-gray-200/60 text-xs">
                    ...
                    <span className="font-extrabold text-[var(--pc-gray-600)]">
                      Total Ticket: <span className="text-[var(--pc-red-500)] font-black">OMR {order.total.toFixed(3)}</span>
                    </span>
                  </div>

                  {/* Order checklist breakdown */}
                  <div className="space-y-3">
                    <h5 className="text-[10px] uppercase font-black text-[var(--pc-gray-500)] tracking-wider">Kitchen Ticket Contents:</h5>
                    
                    <div className="space-y-1.5 max-h-44 overflow-y-auto pr-1">
                      {order.items.map((item, index) => (
                        <div key={index} className="flex justify-between items-center text-xs font-bold text-[var(--pc-gray-700)]">
                          <div className="flex items-center gap-2">
                            <span className="bg-orange-50 text-[var(--pc-red-500)] font-black px-1.5 py-0.5 rounded text-[10px] min-w-[20px] text-center">
                              {item.quantity}
                            </span>
                            <span>{item.name}</span>
                          </div>
                ...
                <div className="text-center pt-2">
                  <p className="text-[10px] text-[var(--pc-gray-500)] font-medium">
            ...
            <div className="bg-[var(--pc-gray-100)] rounded-[2rem] border border-[var(--pc-red-500)]/10 p-12 text-center flex flex-col items-center justify-center space-y-4 min-h-[350px]">
              <div className="w-16 h-16 rounded-full bg-white flex items-center justify-center text-[var(--pc-red-500)] shadow-sm">
                <Package size={32} />
              </div>
              <div className="space-y-2 max-w-sm">
                <p className="font-playfair font-black text-xl text-[var(--pc-gray-700)]">Ready to Track State</p>
                <p className="text-xs text-[var(--pc-gray-500)] leading-relaxed">
                ...
                <div className="pt-2">
                  <span className="inline-block px-3 py-1 bg-white text-[10px] font-black text-[var(--pc-red-500)] rounded-full border border-[var(--pc-red-500)]/20">
